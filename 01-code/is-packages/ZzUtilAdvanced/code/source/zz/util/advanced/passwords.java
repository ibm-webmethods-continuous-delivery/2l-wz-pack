...

{
	...
	final static passwords _instance = new passwords();

	static passwords _newInstance() { return new passwords(); }

	static passwords _cast(Object o) { return (passwords)o; }
